...
data.forEach(data => {
  articles.appendChild(
    createComponent(data.title, data.date, data.content, data.button)
  );
});

function createComponent(title, date, para1, para2, para3, button) {
  //define new elements
  ...
  articleContent.appendChild(contentPara1);
  articleContent.appendChild(contentPara2);
  articleContent.appendChild(contentPara3);
